...
insert into tbSensor values
	(null, 'sala_a', 'OakTruffle'),
    (null, 'sala_b', 'OakTruffle'),
    (null, 'sala_a', 'Santa Luzia');
...
create table dados_coletados(
	n_verificacao int primary key auto_increment
...
update dados_coletados set temperatura = 22.3 where n_verificacao = 1;

update dados_coletados set umidade = 96.3 where n_verificacao = 1;
